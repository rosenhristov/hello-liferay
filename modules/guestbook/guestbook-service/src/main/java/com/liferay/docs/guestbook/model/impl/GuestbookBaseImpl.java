 ...
 *  All methods that expect a guestbook model instance should use the
 *  <code>Guestbook</code> interface instead.
 *
 * <p>
 ...
 * @generated
 */
public abstract class GuestbookBaseImpl extends GuestbookModelImpl implements Guestbook {
	@Override
	public void persist() {
		if (this.isNew()) {
