...
public interface GuestbookEntryLocalService extends BaseLocalService, PersistedModelLocalService {
	...
	GuestbookEntry addGuestbookEntry(GuestbookEntry guestbookEntry);

	GuestbookEntry addGuestbookEntry(long userId, long guestbookId, String name, String email, String message,
	...
	GuestbookEntry createGuestbookEntry(long entryId);
	...
	GuestbookEntry deleteGuestbookEntry(GuestbookEntry guestbookEntry) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	GuestbookEntry deleteGuestbookEntry(long entryId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	GuestbookEntry fetchGuestbookEntry(long entryId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	GuestbookEntry fetchGuestbookEntryByUuidAndGroupId(
