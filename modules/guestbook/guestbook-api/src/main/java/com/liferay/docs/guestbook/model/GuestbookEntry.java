 ...
 */
@ProviderType
@ImplementationClassName("com.liferay.docs.guestbook.model.impl.GuestbookEntryImpl")
public interface GuestbookEntry extends GuestbookEntryModel, PersistedModel {
	 ...
	 */
	Accessor<GuestbookEntry, Long> ENTRY_ID_ACCESSOR = new Accessor<GuestbookEntry, Long>() {
			@Override
